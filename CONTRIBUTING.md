...
# Contributing to @alejofl/password-utilities
...
1. **Clone the repository**:
   ```sh
   git clone https://github.com/alejofl/password-utilities.git
...
- **Commit Message Format**: Commit messages should be descriptive, e.g., `feat: add new shuffle algorithm` following the [Conventional Commits Specification](https://www.conventionalcommits.org/en).
